...
* https://github.com/dagworks-inc/hamilton[Hamilton] - Lightweight Python library to author data transformations as a directed-acyclic graph (DAG). If you like dbt for your SQL transformations, you will like Hamilton for your Python processing.
